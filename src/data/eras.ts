...
export const ERAS: Era[] = [
  ...
  // ── 2. CARTHAGINIAN ───────────────────────────────────────────────────────
  {
    ...
    placePhotos: [
      { src: "/photos/2-punic-motya.jpg", title: "Stagnone Lagoon", location: "Motya Island", caption: "Founded as a 7th-century BC Phoenician colony, Motya sits in a shallow lagoon connected to the mainland by a submerged causeway. It became Carthage's most strategic outpost in western Sicily until Dionysius of Syracuse destroyed it in 397 BC. Today the island is an open-air archaeological park, its silence broken only by wind and wading birds." },
      { src: "/photos/2-punic-ruins.JPG", title: "Valley of the Temples Ruins", location: "Agrigento", caption: "The temples of Akragas bore witness to the brutal Punic Wars — besieged, sacked, and set ablaze between 264 and 210 BCE as Rome and Carthage fought for control of Sicily. What remains are columns scarred by fire and time, standing proof that even ruins can outlast the empires that destroyed them." },
    ],
  ...
  // ── 3. ROMAN ──────────────────────────────────────────────────────────────
  {
    ...
    placePhotos: [
      { src: "/photos/3-roman-syracusa.jpg", title: "Neapolis Archaeological Park", location: "Syracuse", caption: "The Roman amphitheater of Syracuse measures roughly 140 by 119 meters, carved partly from the living rock. Gladiators once fought wild beasts here while thousands watched from the cavea above. Nearby, the Greek theater and the Ear of Dionysius share the same hillside — layers of civilization stacked in a single park." },
  ...
  // ── 6. MODERN ─────────────────────────────────────────────────────────────
  {
    ...
    placePhotos: [
      ...
      { src: "/photos/6-modern-airbnb.JPG", title: "Hanging Out", location: "Catania", caption: "Staying in a local's home, sharing pasta at the kitchen table, and befriending the neighborhood cat. The small, unhurried moments that turn a foreign place into something that feels, briefly, like ours." },
      { src: "/photos/6-modern-hanging out.JPG", title: "Layers of Us", location: "Taormina", caption: "Sicily is shaped by every civilization that passed through — Greek, Punic, Roman, Arab, Norman — each leaving traces that make it what it is. People are like that too. We carry the eras that shaped us. Travel is how you discover each other's layers, see what left its mark, and add a beautiful new one together." },
    ],
